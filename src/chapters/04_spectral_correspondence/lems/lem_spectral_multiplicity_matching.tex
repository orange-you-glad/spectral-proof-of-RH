...
\medskip
\noindent
This multiplicity correspondence is encoded in the canonical determinant identity \thmref{thm:det_identity_revised}, and is ensured by the Hadamard product structure of \( \Xi(s) \) (see \lemref{lem:hadamard_linear_form}) together with the spectral bijection map from \lemref{lem:spectrum_zero_bijection}.
\end{lemma}
