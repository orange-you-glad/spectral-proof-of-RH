...
\lemref{lem:decay_mollified_kernel}
\lemref{lem:xi_growth_bound}
\lemref{lem:uniform_L1_conjugated_kernel}
\lemref{lem:unitary_conjugation_trace_class}
\propref{prop:selfadjointness_Lt}
\propref{prop:core_schwartz_density}
