...
\]
belong to the Schwartz space \( \Schwartz \), and that their inverse Fourier transforms \( k_t := \FT^{-1}[\phi_t] \) decay exponentially in space, as established in \lemref{lem:decay_mollified_kernel}.
\end{lemma}
