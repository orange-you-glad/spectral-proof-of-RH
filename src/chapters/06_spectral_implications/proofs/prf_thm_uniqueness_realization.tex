...
\]
This spectral identity is guaranteed by the determinant representation in \thmref{thm:det_identity_revised}, with normalization provided by \lemref{lem:trace_zero}, and analytic structure fixed via \lemref{lem:hadamard_linear_form}.
