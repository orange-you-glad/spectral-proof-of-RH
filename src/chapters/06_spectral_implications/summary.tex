...
Every lemma, theorem, and corollary in this chapter is either explicitly proved or cited from earlier chapters. No auxiliary assumptions are made. All spectral identities are validated using estimates developed in \thmref{thm:det_identity_revised} and heat kernel bounds from Chapter~\ref{sec:heat_kernel_asymptotics} and Appendix~\ref{app:heat_kernel_construction}.
