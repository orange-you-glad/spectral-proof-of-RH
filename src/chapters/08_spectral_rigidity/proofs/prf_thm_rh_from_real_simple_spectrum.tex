...
By the determinant identity and analytic Fredholm theory (cf. \lemref{lem:det_zero_implies_spectrum}), each nontrivial zero \( \rho = \tfrac{1}{2} + i\gamma \) of \( \zetaR(s) \) corresponds to a spectral eigenvalue \( \mu_\rho = \gamma^{-1} \in \Spec(\Lsym) \setminus \{0\} \).
