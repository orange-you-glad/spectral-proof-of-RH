...
\end{tabular}
\caption{
Canonical spectral encoding of the nontrivial zeros \( \rho_k = \tfrac{1}{2} + i\gamma_k \) of the Riemann zeta function, mapped via \( \mu_{\rho_k} = 1/\gamma_k \) to the real eigenvalues of the canonical operator \( L_{\sym} \in \TC(\HPsi) \). This bijection, proven in \thmref{thm:spectral_zero_bijection_revised}, arises analytically from the identity \( \det\nolimits_\zeta(I - \lambda L_{\sym}) = \XiR(\tfrac{1}{2} + i\lambda)/\XiR(\tfrac{1}{2}) \).
}
