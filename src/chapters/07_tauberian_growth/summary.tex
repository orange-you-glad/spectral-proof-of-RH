...
\medskip
\noindent
(For higher-order heat kernel corrections and refined Tauberian remainder terms, see \appref{app:heat_kernel_refinements}.)
...
This question leads directly to the spectral rigidity results in \thmref{thm:uniqueness_realization}.
\end{remark}
