...
\noindent
Through trace-norm convergence of mollified convolution operators and application of Paley–Wiener theory, we established the canonical determinant identity \thmref{thm:det_identity_revised}:
\[
...
\noindent
This yields a spectral correspondence \thmref{thm:spectral_zero_bijection_revised}:
\[
...
\noindent
We proved the formal analytic equivalence \thmref{thm:eq_of_rh}, completed in \thmref{thm:truth_of_rh}:
\[
\boxed{
