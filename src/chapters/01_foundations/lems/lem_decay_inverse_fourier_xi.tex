...
\medskip
\noindent
This decay follows from the Paley--Wiener theorem: since \( \phi \in \PW{\pi} \) (see \defref{def:paley_wiener_class}) and satisfies exponential type estimates as in \lemref{lem:xi_growth_bound}, its inverse Fourier transform \( k(x) \) decays faster than \( e^{-\alpha |x|} \) for every \( \alpha > \pi \). The result quantifies the optimal spatial localization of Paley--Wiener kernels in \( H_{\Psi_\alpha} \).
\end{lemma}
