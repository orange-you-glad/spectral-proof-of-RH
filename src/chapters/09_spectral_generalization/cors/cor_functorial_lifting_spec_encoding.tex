...
Let \( \pi \in \mathcal{A}_{\mathrm{cusp}}(\GL_n) \), and assume the analytic and spectral hypotheses of \thmref{thm:spectral_determinant_identity_Lpi}. Then the operator \( \Lsympi \in \TC(\Hpsipi) \) provides a compact, self-adjoint, trace-class lift of the zero distribution of \( \Xi(s, \pi) \), in the sense that
\[
