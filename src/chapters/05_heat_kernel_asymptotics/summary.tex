...
\begin{itemize}
  % --- Definitions ---
  \item \defref{def:heat-operator} — Definition of the heat semigroup \( e^{-tL^2} \) for compact, self-adjoint operators, including trace-class representation and strong continuity properties.

  % --- Kernel Bounds and Local Expansion ---
  \item \lemref{lem:hk-upper-bound} — Upper bound:
  \[
  ...
  \item \lemref{lem:hk-lower-bound} — Lower bound:
  \[
  ...
  \item \lemref{lem:heat-trace-expansion} — Trace-class asymptotic expansion:
  \[
  ...
  \item \propref{prop:two-sided-heat-trace-bounds} — Two-sided estimate:
  \[
  ...
  \item \lemref{lem:log-derivative-determinant} — Logarithmic derivative of the spectral determinant:
  \[
  ...
  \item \remref{rem:spectral-dimension} — Spectral dimension and Weyl asymptotics:
  \[
