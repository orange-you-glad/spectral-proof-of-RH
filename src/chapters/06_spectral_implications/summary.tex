...
\]
a purely operator-theoretic criterion grounded in canonical zeta-determinant identity (\thmref{thm:det_identity_revised}) and spectral encoding of zeros (\thmref{thm:spectral_zero_bijection_revised}).
