...
\begin{itemize}
    ...
    \]
    where \( \{ \lambda_n \} \) are the eigenvalues of \( T \in \mathcal{C}_1(H) \), converges absolutely and defines an entire function of exponential type (see \appref{app:zeta_trace_background}).
\end{itemize}
