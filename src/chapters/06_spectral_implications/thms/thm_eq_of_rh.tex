...
\begin{enumerate}
  \item The canonical determinant identity (see \thmref{thm:det_identity_revised});
  \item The bijective, multiplicity-preserving spectral map
  \[
  \rho \longmapsto \mu_\rho := \tfrac{1}{i}(\rho - \tfrac{1}{2}),
  \]
  proven in \thmref{thm:spectral_zero_bijection_revised} and \lemref{lem:spectrum_zero_bijection}, which identifies the nontrivial zeros of \( \zeta(s) \) with the nonzero spectrum of \( \Lsym \);
  \item The equivalence \( \mu_\rho \in \R \iff \Re(\rho) = \tfrac{1}{2} \), derived from spectral symmetry (see \lemref{lem:spectral_symmetry}).
\end{enumerate}
