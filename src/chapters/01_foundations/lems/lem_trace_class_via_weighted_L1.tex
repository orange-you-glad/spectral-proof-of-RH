...
\]
By \lemref{lem:L1_integrability_conjugated_kernel}, \( \widetilde{K} \in L^1(\mathbb{R}^2) \), and by Simon’s trace-class kernel theorem \cite[Thm.~4.2]{Simon2005TraceIdeals} and its analytic justification in \lemref{lem:trace_class_conjugated_kernel}, it follows that \( \widetilde{T} \in \mathcal{C}_1(L^2(\mathbb{R})) \). Hence,
\[
