...
\end{equation*}
where the product ranges over all nontrivial zeros \(\rho\) and \(\mu_{\rho} = \tfrac{1}{i}(\rho-\tfrac{1}{2})\).  The Tauberian arguments of Chapter~\ref{sec:tauberian_growth} show that this product converges absolutely and that the eigenvalue counting function agrees with the classical Riemann--von Mangoldt formula.  Hence each zero of \(\Xi(s)\) produces an eigenvalue of \(\Lsym\), and no additional spectral points occur.  Combined with \lemref{lem:log_corrected_tauberian_estimate}, this identifies the spectral counting function of \(\Lsym\) precisely with the zeta zero counting function.
