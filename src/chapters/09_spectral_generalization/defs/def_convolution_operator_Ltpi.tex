\begin{definition}[Mollified Convolution Operator \( \Ltpi \)]
\label{def:convolution_operator_Ltpi}
Let \( \pi \in \mathcal{A}_{\mathrm{cusp}}(\GL_n) \) and fix \( \alphapi > 0 \) such that the decay condition of \defref{def:kernel_decay_condition} holds. Let
\[
