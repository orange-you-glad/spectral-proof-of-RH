begin{proof}[Proof of \lemref{lem:spectral_heat_trace_representation}]
We prove Lemma~\ref{lem:spectral_heat_trace_representation} using the spectral theorem and properties of trace-class semigroups.
