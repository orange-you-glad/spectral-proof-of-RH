...
\begin{itemize}
  ...
  The derived asymptotic matches the classical Riemann–von Mangoldt formula for zeta zeros. This match, proven in \corref{cor:zeta_compatibility}, confirms that the spectrum of \( L_{\mathrm{sym}} \) encodes the zero distribution of \( \zeta(s) \).
\end{itemize}
