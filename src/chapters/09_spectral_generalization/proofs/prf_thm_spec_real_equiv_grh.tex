...
\]
with multiplicities preserved. This spectral encoding arises from the Fredholm determinant identity of \thmref{thm:spectral_determinant_identity_Lpi}, built from mollified kernels in \defref{def:kernel_decay_condition} and converging as per \lemref{lem:trace_class_convergence_general}.
